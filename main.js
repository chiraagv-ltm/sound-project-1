...
document.getElementById("1").innerHTML="<h5 id='1'>detected dog - 0<h5>"
document.getElementById("2").innerHTML="<h5 id='2'>detected cat - 0<h5>"
document.getElementById("3").innerHTML="<h5 id='3'>detected background noise - 0<h5>"
...
document.getElementById("results_label").style.color="rgb("+random_number_r+","+random_number_g+","+random_number_b+")";
  ...
  document.getElementById("3").innerHTML="<h5 id='3'>detected background noise - "+counter_BN+"</h5>";
}
    ...
    document.getElementById("1").innerHTML="<h5 id='1'>detected dog - "+counter_dog+"</h5>" ;
  ...
  document.getElementById("2").innerHTML="<h5 id='2'>detected cat - "+counter_cat+"</h5>";
